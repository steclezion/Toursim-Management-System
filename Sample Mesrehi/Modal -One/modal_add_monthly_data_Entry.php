	<div id="add_Establishment" class="modal hide fade" tabindex="-1" Establishment="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
	...
	<form class="form-horizontal" method="post">
		...
		<div class="alert alert-info"><strong>Add Establishment</strong></div>
