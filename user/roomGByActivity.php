<div id="aggrga" class="modal hide fade in active" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">

    <div class="modal">
      <p id="demo"></p>


      <div class="alert badge-inverse"><strong style="color:white">Room Group By Activity</strong></div>
  
  <form class="form-horizontal" role="form" method="post" action="reportRGA.php">
...
function rga(str) {
  if (str=="") {
    document.getElementById("rgroup").innerHTML="";
    return;
  }
  ...
  xmlhttp.onreadystatechange=function() {
    if (xmlhttp.readyState==4 && xmlhttp.status==200) {
      document.getElementById("rgroup").innerHTML=xmlhttp.responseText;
    }
  }
  xmlhttp.open("GET","ajaxRoomG.php?rg="+str,true);
  xmlhttp.send();
}
</script>
...
<select name="month1" onchange="rga(this.value)" required>
    ...
    <option value="<?php echo $myMonth[0]; ?>"><?php echo $myMonth[0]; ?> </option>
     ...
     <div class="control" id="rgroup"><b>.</b></div>    
...
function showUse_sub_zoba(str) {
  ...
  xmlhttp.open("GET","makuser.php?r="+str,true);
  xmlhttp.send();
}
</script>
...
<select name="estabzoba" required  onchange="showUse_sub_zoba(this.value)" >
    ...
    <option value="<?php echo $row_sub_zoba[0]; ?>"><?php echo $row_sub_zoba[1]; ?> </option>
     ...
     <div  class="control"  id="txtHintp"><b>.</b></div>
    
      <div class="control-group">
        <div class="controls">
        <button type="submit" name="Report" class="alert badge-inverse"><i class="icon-save icon-large"></i>&nbsp; Preview Room-Group Report</button>
        </div>
      </div>
