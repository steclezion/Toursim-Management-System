...
<?php include('navbar_dashboard.php'); ?>
	  ...
	  $est_query=mysql_query("select * from  establishment_entry where Establishment_Id='$Est_id' ")or die(mysql_error());
...
<div class="container">
  ...
  <div data-role="main" class="ui-content">
    <form method="post" action="monthly_entry_process.php">
        <div class="ui-field-contain">
        <label for="Rooms">Room Offered :</label>
        <input required type="number" name="rooms" autofocus id="rooms">        
        <label for="Bed-Offered">Bed Offered:</label>            
        <input type="number" name="bed"  required id="bed" >           
          <label for="un_offered_Rooms">Un Offered Rooms:</label>
        <input type="number" required name="un_rooms" id="rooms">       
        <label for="Bed-Offered">Un Offered Beds:</label>
        <input required type="number" name="un_bed" id="bed">
		</div>
...
<br/>
  ...
  <div data-role="main" class="ui-content">
     <form method="post" action="monthly_entry_process.php">
      <div class="ui-field-contain">
        ...
        <input required type="number" name="Non_Res" autofocus  id="Non_Res">       
        <label for="Resident">Resident New Guests:</label>
        <input required type="number" name="Resident" id="Resident">
          <label for="Occupied_Rooms">Occupied Rooms:</label>
        <input required type="number" name="Occupied_Rooms" id="Occupied_rooms">       
        <label for="Total_Resident">Total Resident:</label>
        <input required type="number" name="Total_Resident" id="Total_Resident">
		  <label for="Total_Non_Resident">Total Non Resident:</label>
        <input required type="number" name="Total_Non_Resident" id="Total_Resident">
		 <label for="Total_Num_Guests">Total Number of Guests:</label>
        <input required type="number" name="Total_Num_Guests" id="Total_Num_Guests">
      </div>
     <br/>
  <input type="submit" name="Guests" data-inline="true" value="Submit">
   <br/>
 </div>
  </form>
</div>
 ...
 <form method="post" action="monthly_entry_process.php">
      <div class="ui-field-contain">
        ...
        <input type="number" required name="Non_Resident_Bed_Revnue" autofocus  id="Non_Res_Bed_Rev">       
        <label for="Resident_Bed">Resident Bed Revenue:</label>
        <input type="number" required name="Resident_Bed_Revenue" id="Resident">
          <label for="Occupied_Rooms">Food Revenue:</label>
        <input type="number" required name="Food_Revenue" id="food Revenue">       
        <label for="Alcholic_Drink_Revenue">Alcholic Drink Revenue</label>
        <input type="number" required name="Alcholic_Bed_Revenue" id="Alcholic_Drink_Revenue">
		  <label for="Soft_Drinks_Revenue">Soft Drinks Revenue:</label>
        <input required  type="number" name="soft_Drinks_Revenue" id="soft_Drinks">
		 <label for="Hot_Drinks_Revenue">Hot Drinks Revenue:</label>
        <input required  type="number" name="Hot_Drinks" id="Hot_Drinks">
		 <label for="Other_Revenue">Other Revenue:</label>
        <input required  type="number" name="Other_Revenue" id="other_Revneue">
      </div>
     <br/>
...
<form method="post" action="monthly_entry_process.php">
      <div class="ui-field-contain">
        ...
        <input type="number" name="Male" autofocus  Title="Fill Males Numbers"id="Male">       
        <label for="Resident_Bed">Female:</label>
        <input type="number" name="Female" id="Resident">
  ...
  <div id="demo-header"></div>
    <div class="container">    
<div class="container">
  <h2>Complete Information <B style="color:RED" ><?php  echo $row[3]."  ".$row[6]; ?></B></h2>
                ...
                <div class="row">
                    <table class= "table table-striped table-bordered table-hover">
                        ...
                        <tbody>
                        <?php
						$query = mysql_query("select * from  monthly_data_entry  where ( Establishment_Id='$Est_id' and Month='$Month' and  Year='$year' and Check_Status=1)");
						$i=0;
						while($fetch = mysql_fetch_array($query))
						{
							...
							echo'<tr class="'.$class.'">
                              ...
                              <td><b><u style="color:red"><mark><span style="color:black"  id="'.$fetch[2].'">'.$fetch[2].'</span></mark></u></b></td>
				               ...
				               <td><span class="Offered_Beds" Offered_Beds="'.$fetch[2].'"> '.$fetch[23].'</span></td>
					           <td><span class="Unoffered_Rooms" Unoffered_Rooms="'.$fetch[2].'">'.$fetch[20].'</span></td>
						       <td><span class="Unoffered_Beds" Unoffered_Beds="'.$fetch[2].'">'.$fetch[21].'</span></td>
			                   <td><span class="NR_Guest" id="'.$fetch[2].'"> '.$fetch[5].'</span></td>
				               <td><span class="R_NewGuest" R_NewGuest="'.$fetch[2].'">'.$fetch[6].'</span></td>
				               <td><span class="Rooms_Occupied" Rooms_Occupied="'.$fetch[2].'">'.$fetch[7].'</span></td>																										   
                               <td><span class="TNR_Guest" TNR_Guest="'.$fetch[2].'">'.$fetch[8].'</span></td>
				               <td><span class="TR_Guest" TR_Guest="'.$fetch[2].'">'.$fetch[9].'</span></td>
				               <td><span class="Total_Guest" Total_Guest="'.$fetch[2].'">'.$fetch[10].'</span></td>
				               <td><span class="NRB_Revenue"  NRB_Revenue="'.$fetch[2].'">'.$fetch[11].'</span></td>
				           	   <td><span class="RB_Revenue" RB_Revenue="'.$fetch[2].'">'.$fetch[12].'</span></td>
					   	       <td><span class="FB_Revenue" FB_Revenue="'.$fetch[2].'">'.$fetch[13].'</span></td>
						   	   <td><span class="AlRevenue"  AlRevenue="'.$fetch[2].'">'.$fetch[14].'</span></td>
                       	       <td><span class="HotRevenue" HotRevenue="'.$fetch[2].'">'.$fetch[15].'</span></td>
						   	   <td><span class="SRevenue"  SRevenue="'.$fetch[2].'">'.$fetch[16].'</span></td>
							   <td><span class="ORevenue" ORevenue="'.$fetch[2].'">'.$fetch[17].'</span></td>
							   <td><span class= "Male"  Male="'.$fetch[2].'">'.$fetch[18].'</span></td>
							   <td><span class= "Female" Female="'.$fetch[2].'">'.$fetch[19].'</span></td>
                            </tr>';						
		...
		<div class="row">
                    <table class= "table table-striped table-bordered table-hover">
                        ...
                        <tbody>
                        <?php
						$query = mysql_query("select * from  monthly_data_entry  where ( Establishment_Id='$Est_id' and  Year='$year' and Check_Status=1)");
						$i=0;
						while($fetch = mysql_fetch_array($query))
						{
							if($i%2==0) $class = 'even'; else $class = 'odd';
							...
							echo'<tr class="'.$class.'">
                             ...
                             <td><b><u style="color:red"><mark><span style="color:black"  id="'.$fetch[2].'">'.$fetch[2].'</span></mark></u></b></td>
                               <td><mark><u><span  id="'.$fetch[2].'"> '.$fetch[3].'</span></u></mark></td>
							   <td><mark><u><span  id="'.$fetch[2].'"> '.$fetch[4].'</span></u></mark></td>
							   <td><span  id="'.$fetch[2].'"> '.$fetch[22].'</span></td>
				               <td><span id="'.$fetch[2].'"> '.$fetch[23].'</span></td>
					           <td><span  id="'.$fetch[2].'">'.$fetch[20].'</span></td>
						       <td><span  id="'.$fetch[2].'">'.$fetch[21].'</span></td>
			                   <td><span  id="'.$fetch[2].'"> '.$fetch[5].'</span></td>
				               <td><span  id="'.$fetch[2].'">'.$fetch[6].'</span></td>
				               <td><span  id="'.$fetch[2].'">'.$fetch[7].'</span></td>																										   
                               <td><span  id="'.$fetch[2].'">'.$fetch[8].'</span></td>
				               <td><span  id="'.$fetch[2].'">'.$fetch[9].'</span></td>
				               <td><span  id="'.$fetch[2].'">'.$fetch[10].'</span></td>
				               <td><span  id="'.$fetch[2].'">'.$fetch[11].'</span></td>
				           	   <td><span  id="'.$fetch[2].'">'.$fetch[12].'</span></td>
					   	       <td><span  id="'.$fetch[2].'">'.$fetch[13].'</span></td>
						   	   <td><span  id="'.$fetch[2].'">'.$fetch[14].'</span></td>
                       	       <td><span  id="'.$fetch[2].'">'.$fetch[15].'</span></td>
						   	   <td><span  id="'.$fetch[2].'">'.$fetch[16].'</span></td>
							   <td><span id="'.$fetch[2].'">'.$fetch[17].'</span></td>
							   <td><span  id="'.$fetch[2].'">'.$fetch[18].'</span></td>
							   <td><span  id="'.$fetch[2].'">'.$fetch[19].'</span></td>
                            </tr>';						
...
jQuery(document).ready(function() {  
		...
		$(document).on('click','.editable-submit',function(){
			...
			$.ajax({
				url: "process.php?id="+x+"&NR_Guest_data="+y,
				type: 'GET',
				success: function(s){
					if(s == 'status'){
					$(z).html(y);}
...
jQuery(document).ready(function() {  
		...
		$(document).on('click','.editable-submit',function(){
			...
			var z = $(this).closest('td').children('span');
			$.ajax({
				url: "process.php?Offered_Rooms="+x+"&Offered_Rooms_data="+y,
				type: 'GET',
				success: function(s){
					if(s == 'status'){
					$(z).html(y);}
...
jQuery(document).ready(function() {  
		...
		$(document).on('click','.editable-submit',function(){
			...
			var z = $(this).closest('td').children('span');
			$.ajax({
				url: "process.php?Offered_Beds="+x+"&Offered_Beds_data="+y,
				type: 'GET',
				success: function(s){
					if(s == 'status'){
					$(z).html(y);}
...
jQuery(document).ready(function() {  
		...
		$(document).on('click','.editable-submit',function(){
			...
			var z = $(this).closest('td').children('span');
			$.ajax({
				url: "process.php?Unoffered_Rooms="+x+"&Unoffered_Rooms_data="+y,
				type: 'GET',
				success: function(s){
					if(s == 'status'){
					$(z).html(y);}
...
jQuery(document).ready(function() {  
		...
		$(document).on('click','.editable-submit',function(){
			...
			var z = $(this).closest('td').children('span');
			$.ajax({
				url: "process.php?Unoffered_Beds="+x+"&Unoffered_Beds_data="+y,
				type: 'GET',
				success: function(s){
					if(s == 'status'){
					$(z).html(y);}
...
jQuery(document).ready(function() {  
		...
		$(document).on('click','.editable-submit',function(){
			...
			var z = $(this).closest('td').children('span');
			$.ajax({
				url: "process.php?R_NewGuest="+x+"&R_NewGuest_data="+y,
				type: 'GET',
				success: function(s){
					if(s == 'status'){
					$(z).html(y);}
...
jQuery(document).ready(function() {  
		...
		$(document).on('click','.editable-submit',function(){
			...
			var z = $(this).closest('td').children('span');
			$.ajax({
				url: "process.php?Rooms_Occupied="+x+"&Rooms_Occupied_data="+y,
				type: 'GET',
				success: function(s){
					if(s == 'status'){
					$(z).html(y);}
...
jQuery(document).ready(function() {  
		...
		$(document).on('click','.editable-submit',function(){
			...
			var z = $(this).closest('td').children('span');
			$.ajax({
				url: "process.php?TNR_Guest="+x+"&TNR_Guest_data="+y,
				type: 'GET',
				success: function(s){
					if(s == 'status'){
					$(z).html(y);}
...
jQuery(document).ready(function() {  
		...
		$(document).on('click','.editable-submit',function(){
			...
			var z = $(this).closest('td').children('span');
			$.ajax({
				url: "process.php?TR_Guest="+x+"&TR_Guest_data="+y,
				type: 'GET',
				success: function(s){
					if(s == 'status'){
					$(z).html(y);}
...
jQuery(document).ready(function() {  
		...
		$(document).on('click','.editable-submit',function(){
			...
			var z = $(this).closest('td').children('span');
			$.ajax({
				url: "process.php?Total_Guest="+x+"&Total_Guest_data="+y,
				type: 'GET',
				success: function(s){
					if(s == 'status'){
					$(z).html(y);}
...
jQuery(document).ready(function() {  
		...
		$(document).on('click','.editable-submit',function(){
			...
			var z = $(this).closest('td').children('span');
			$.ajax({
				url: "process.php?NRB_Revenue="+x+"&NRB_Revenue_data="+y,
				type: 'GET',
				success: function(s){
					if(s == 'status'){
					$(z).html(y);}
...
jQuery(document).ready(function() {  
		...
		$(document).on('click','.editable-submit',function(){
			...
			var z = $(this).closest('td').children('span');
			$.ajax({
				url: "process.php?RB_Revenue="+x+"&RB_Revenue_data="+y,
				type: 'GET',
				success: function(s){
					if(s == 'status'){
					$(z).html(y);}
...
jQuery(document).ready(function() {  
		...
		$(document).on('click','.editable-submit',function(){
			...
			var z = $(this).closest('td').children('span');
			$.ajax({
				url: "process.php?FB_Revenue="+x+"&FB_Revenue_data="+y,
				type: 'GET',
				success: function(s){
					if(s == 'status'){
					$(z).html(y);}
...
jQuery(document).ready(function() {  
		...
		$(document).on('click','.editable-submit',function(){
			...
			var z = $(this).closest('td').children('span');
			$.ajax({
				url: "process.php?AlRevenue="+x+"&AlRevenue_data="+y,
				type: 'GET',
				success: function(s){
					if(s == 'status'){
					$(z).html(y);}
...
jQuery(document).ready(function() {  
		...
		$(document).on('click','.editable-submit',function(){
			...
			var z = $(this).closest('td').children('span');
			$.ajax({
				url: "process.php?HotRevenue="+x+"&HotRevenue_data="+y,
				type: 'GET',
				success: function(s){
					if(s == 'status'){
					$(z).html(y);}
...
jQuery(document).ready(function() {  
		...
		$(document).on('click','.editable-submit',function(){
			...
			var z = $(this).closest('td').children('span');
			$.ajax({
				url: "process.php?SRevenue="+x+"&SRevenue_data="+y,
				type: 'GET',
				success: function(s){
					if(s == 'status'){
					$(z).html(y);}
...
jQuery(document).ready(function() {  
		...
		$(document).on('click','.editable-submit',function(){
			...
			var z = $(this).closest('td').children('span');
			$.ajax({
				url: "process.php?ORevenue="+x+"&ORevenue_data="+y,
				type: 'GET',
				success: function(s){
					if(s == 'status'){
					$(z).html(y);}
...
jQuery(document).ready(function() {  
		...
		$(document).on('click','.editable-submit',function(){
			...
			var z = $(this).closest('td').children('span');
			$.ajax({
				url: "process.php?Male="+x+"&Male_data="+y,
				type: 'GET',
				success: function(s){
					if(s == 'status'){
					$(z).html(y);}
...
jQuery(document).ready(function() {  
		...
		$(document).on('click','.editable-submit',function(){
			...
			var z = $(this).closest('td').children('span');
			$.ajax({
				url: "process.php?Female="+x+"&Female_data="+y,
				type: 'GET',
				success: function(s){
					if(s == 'status'){
					$(z).html(y);}
