<div id="ag" class="modal hide fade in active" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">

    <div class="modal">
      <p id="demo"></p>


      <div class="alert badge-inverse"><strong style="color:white">Aggregate Revenue</strong></div>
  
  <form class="form-horizontal" role="form" method="post" action="reportAggRevenue.php">
...
function aggRev(str) {
  ...
  xmlhttp.open("GET","ajaxRev.php?re="+str,true);
  xmlhttp.send();
}
</script>
...
<select name="month1" onchange="aggRev(this.value)" required>
    ...
    <option value="<?php echo $myMonth[0]; ?>"><?php echo $myMonth[0]; ?> </option>
     ...
     <div class="control" id="rev"><b>.</b></div>  
