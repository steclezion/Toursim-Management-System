<div id="dr" class="modal hide fade in active" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">

    <div class="modal">
      <p id="demo"></p>


      <div class="alert badge-inverse"><strong style="color:white">Detailed Revenue</strong></div>
  
  <form class="form-horizontal" role="form" method="post" action="reportDR.php">
...
function drev(str) {
  if (str=="") {
    document.getElementById("detrev").innerHTML="";
    return;
  }
  ...
  xmlhttp.onreadystatechange=function() {
    if (xmlhttp.readyState==4 && xmlhttp.status==200) {
      document.getElementById("detrev").innerHTML=xmlhttp.responseText;
    }
  }
  xmlhttp.open("GET","ajaxdetRev.php?dr="+str,true);
  xmlhttp.send();
}
</script>
...
<select name="month1" onchange="drev(this.value)" required>
    ...
    <option value="<?php echo $myMonth[0]; ?>"><?php echo $myMonth[0]; ?> </option>
     ...
     <div class="control" id="detrev"><b>.</b></div>  
  ...
  <div class="control-group">
      ...
      <div class="control-group">
        <div class="controls">
        <button type="submit" name="Report" class="alert badge-inverse"><i class="icon-save icon-large"></i>&nbsp; Preview Detailed Report</button>
        </div>
      </div>
