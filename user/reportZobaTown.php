  ...
  <div ><br><br><br></div>
     ...
     <div class="jumbotron">
       ...
       <table cellpadding="0" cellspacing="0" border="0" class="table  table-bordered" id="ex" >
                ...
                <tbody>
                  ...
                  <tr>
                  <td colspan="12" class="info"><i style="color:blue; font-size:18px; font-weight: bold;">Maekel</i></td>  
                  </tr>
   ...
   // calculation person per room
    ...
    <td><?php  echo $sum = $nrg + $rg; ?></td>                                           
                  ...
                  <?php 
   $show_rpt = mysql_query("insert into zobatown(estabname,ro,bo,ror,bor,ppr,nr,res,overall,nonres,resident,total) values('$estabName','$ro','$ob','$roo','$boo','$pp','$ads','$asr','$orl','$nrg','$rg','$sum')"); 
      ...
      $show_rpt = mysql_query("insert into zobatown(estabname,ro,bo,ror,bor,ppr,nr,res,overall,nonres,resident,total) 
        values('SubTotal','$t','$m','$ford','$camry','$ferrari','$lambo','$das','$carbo','$twit','$book','$pen')"); 
                  ...
                  <tr>
                  <td colspan="12" class="info"><i style="color:blue; font-size:18px; font-weight: bold;">Debub</i></td>  
                  </tr>
   ...
   // calculation person per room
    ...
    <td><?php  echo $sum1 = $nrg1 + $rg1; ?></td>                                           
                  ...
                  <?php  
       $show_rpt = mysql_query("insert into zobatown(estabname,ro,bo,ror,bor,ppr,nr,res,overall,nonres,resident,total) values('$estabName1','$ro1','$ob1','$roo1','$boo1','$pp1','$ads1','$asr1','$orl1','$nrg1','$rg1','$sum1')"); 
      ...
      $show_rpt = mysql_query("insert into zobatown(estabname,ro,bo,ror,bor,ppr,nr,res,overall,nonres,resident,total) 
        values('SubTotal','$t1','$m1','$ford1','$camry1','$ferrari1','$lambo1','$das1','$carbo1','$twit1','$book1','$pen1')"); 
                  ...
                  <tr>
                  <td colspan="12" class="info"><i style="color:blue; font-size:18px; font-weight: bold;">Anseba</i></td>  
                  </tr>
   ...
   // calculation person per room
    ...
    <td><?php  echo $sum2 = $nrg2 + $rg2; ?></td>                                           
                  ...
                  <?php  
                $show_rpt = mysql_query("insert into zobatown(estabname,ro,bo,ror,bor,ppr,nr,res,overall,nonres,resident,total) values('$estabName2','$ro2','$ob2','$roo2','$boo2','$pp2','$ads2','$asr2','$orl2','$nrg2','$rg2','$sum2')"); 
      ...
      $ksa2 = $gmt2 / 2;
       ...
       $show_rpt = mysql_query("insert into zobatown(estabname,ro,bo,ror,bor,ppr,nr,res,overall,nonres,resident,total) 
        values('SubTotal','$t2','$m2','$ford2','$camry2','$ferrari2','$lambo2','$das2','$carbo2','$twit2','$book2','$pen2')"); 
                 ...
                 <tr>
                  <td colspan="12" class="info"><i style="color:blue; font-size:18px; font-weight: bold;">Northern Red Sea</i></td>  
                  </tr>
   ...
   // calculation person per room
    ...
    ?>   
                    ...
                    <tr>                                 
                    <td><?php echo $estabName3;?></td>   
                    <td><?php echo $ro3; ?></td> 
                    <td><?php echo $ob3; ?></td> 
                     <td><?php echo $roo3 = round($final3, 2).'%'; ?></td>
    <td><?php echo $boo3 = round($result3, 2).'%'; ?></td>   
    <td><?php echo $pp3 = round($PPR3, 2); ?></td>  
     
    <td><?php  echo $ads3 = round($ADSNR3, 2); ?></td>
    <td><?php  echo $asr3 = round($ADSR3, 2); ?></td>   
    <td><?php  echo $orl3 = round($overall3, 2); ?></td> 
    
      <td><?php echo $nrg3; ?></td>
    <td><?php  echo $rg3; ?></td>   
    <td><?php  echo $sum3 = $nrg3 + $rg3; ?></td>                                           
                  </tr>
                  <?php 
      $show_rpt = mysql_query("insert into zobatown(estabname,ro,bo,ror,bor,ppr,nr,res,overall,nonres,resident,total) values('$estabName3','$ro3','$ob3','$roo3','$boo3','$pp3','$ads3','$asr3','$orl3','$nrg3','$rg3','$sum3')"); 
...
$show_rpt = mysql_query("insert into zobatown(estabname,ro,bo,ror,bor,ppr,nr,res,overall,nonres,resident,total) 
        values('SubTotal','$t3','$m3','$ford3','$camry3','$ferrari3','$lambo3','$das3','$carbo3','$twit3','$book3','$pen3')"); 
           ...
           <!--Zoba Gash Barka-->
                 <tr>
                  <td colspan="12" class="info"><i style="color:blue; font-size:18px; font-weight: bold;">Gash Barka</i></td>  
                  </tr>
   ...
   // calculation person per room
    ...
    ?>   
                    ...
                    <tr>                                 
                    <td><?php echo $estabName4;?></td>   
                    <td><?php echo $ro4; ?></td> 
                    <td><?php echo $ob4; ?></td> 
                     <td><?php echo $roo4 = round($final4, 2).'%'; ?></td>
    <td><?php echo $boo4 = round($result4, 2).'%'; ?></td>   
    <td><?php echo $pp4 = round($PPR4, 2); ?></td>  
     
    <td><?php  echo $ads4 = round($ADSNR4, 2); ?></td>
    <td><?php  echo $asr4 = round($ADSR4, 2); ?></td>   
    <td><?php  echo $orl4 = round($overall4, 2); ?></td> 
    
      <td><?php echo $nrg4; ?></td>
    <td><?php  echo $rg4; ?></td>   
    <td><?php  echo $sum4 = $nrg4 + $rg4; ?></td>                                           
                  </tr>
                  <?php 
      $show_rpt = mysql_query("insert into zobatown(estabname,ro,bo,ror,bor,ppr,nr,res,overall,nonres,resident,total) values('$estabName4','$ro4','$ob4','$roo4','$boo4','$pp4','$ads4','$asr4','$orl4','$nrg4','$rg4','$sum4')"); 
...
$show_rpt = mysql_query("insert into zobatown(estabname,ro,bo,ror,bor,ppr,nr,res,overall,nonres,resident,total) 
        values('SubTotal','$t4','$m4','$ford4','$camry4','$ferrari4','$lambo4','$das4','$carbo4','$twit4','$book4','$pen4')"); 
           ...
           <!--Zoba Southern Red Sea-->
                 <tr>
                  <td colspan="12" class="info"><i style="color:blue; font-size:18px; font-weight: bold;">Southern Red Sea</i></td>  
                  </tr>
   ...
   // calculation person per room
    ...
    ?>   
                    ...
                    <tr>                                 
                    <td><?php echo $estabName5;?></td>   
                    <td><?php echo $ro5; ?></td> 
                    <td><?php echo $ob5; ?></td> 
                     <td><?php echo $roo5 = round($final5, 2).'%'; ?></td>
    <td><?php echo $boo5 = round($result5, 2).'%'; ?></td>   
    <td><?php echo $pp5 = round($PPR5, 2); ?></td>  
     
    <td><?php  echo $ads5 = round($ADSNR5, 2); ?></td>
    <td><?php  echo $asr5 = round($ADSR5, 2); ?></td>   
    <td><?php  echo $orl5 = round($overall5, 2); ?></td> 
    
      <td><?php echo $nrg5; ?></td>
    <td><?php  echo $rg5; ?></td>   
    <td><?php  echo $sum5 = $nrg5 + $rg5; ?></td>                                           
                  </tr>
                  <?php  
    $show_rpt = mysql_query("insert into zobatown(estabname,ro,bo,ror,bor,ppr,nr,res,overall,nonres,resident,total) values('$estabName5','$ro5','$ob5','$roo5','$boo5','$pp5','$ads5','$asr5','$orl5','$nrg5','$rg5','$sum5')"); 
