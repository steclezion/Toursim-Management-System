 <?php
	...
	if(isset($_POST["Export"])){
      ...
      fputcsv($output,array('Year','Month','Establishment Town','Sum Of Rooms','Sum Of Beds','Total Establishment Id'));  

    $query_result= mysql_query("select * from countEstab");
