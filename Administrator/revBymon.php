<div id="aggrm" class="modal hide fade in active" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">

		<div class="modal">
			<p id="demo"></p>


			<div class="alert badge-inverse"><strong style="color:white">Revenue By Month</strong></div>
	
	<form class="form-horizontal" role="form" method="post" action="reportRBM.php">
...
function rbm(str) {
  ...
  xmlhttp.open("GET","ajaxRevbm.php?revb="+str,true);
  xmlhttp.send();
}
</script>
...
<select name="month1" onchange="rbm(this.value)" required>
    ...
    <option value="<?php echo $myMonth[0]; ?>"><?php echo $myMonth[0]; ?> </option>
     ...
     <div class="control" id="rb"><b>.</b></div>  
	...
	<div class="control-group">
			...
			<div class="control-group">
				<div class="controls">
				<button type="submit" name="Report" class="alert badge-inverse"><i class="icon-save icon-large"></i>&nbsp; Preview Revenue Report</button>
				</div>
			</div>
