<div id="detailed" class="modal hide fade in active" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">

		<div class="modal">
			<p id="demo"></p>


			<div class="alert badge-inverse"><strong style="color:white">Aggregate Detailed Report</strong></div>
	
	<form class="form-horizontal" role="form" method="post" action="reportDetailed.php">
...
function det(str) {
  ...
  xmlhttp.open("GET","ajaxdetail.php?dt="+str,true);
  xmlhttp.send();
}
</script>
...
<select name="month1" onchange="det(this.value)" required>
    ...
    <option value="<?php echo $myMonth[0]; ?>"><?php echo $myMonth[0]; ?> </option>
     ...
     <div class="control" id="detail"><b>.</b></div>    
