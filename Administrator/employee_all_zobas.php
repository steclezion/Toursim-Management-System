...
$query_Create = mysql_query("CREATE VIEW `tourism`.`sample3` AS select *  from  report_employee_town where (Year='$Year' and Activity='$activity' and Check_Status=1 and  (Month BETWEEN '$Month_one'  and '$Month_two') )");
