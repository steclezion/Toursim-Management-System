  ...
  <div ><br><br><br></div>
     ...
     <div class="jumbotron">
       ...
       <table cellpadding="0" cellspacing="0" border="0" class="table  table-bordered" id="ex" >
            ...
            $xls_report = mysql_query("delete from aggallzoba");
    ...
    $result = $BOR / $ob;
      ...
      $ksa = $gmt / 2;
         ...
         ?>
                  ...
                  <?php 
      $show_rpt = mysql_query("insert into aggallzoba(estabname,ro,bo,ror,bor,ppr,nr,res,overall,nonres,resident,total) 
        values('Maekel','$t','$m','$ford','$camry','$ferrari','$lambo','$das','$carbo','$twit','$book','$pen')"); 
    ...
    $result1 = $BOR1 / $ob1;
      ...
      $ksa1 = $gmt1 / 2;
         ...
         ?>
                  ...
                  <?php 
      $show_rpt = mysql_query("insert into aggallzoba(estabname,ro,bo,ror,bor,ppr,nr,res,overall,nonres,resident,total) 
        values('Debub','$t1','$m1','$ford1','$camry1','$ferrari1','$lambo1','$das1','$carbo1','$twit1','$book1','$pen1')"); 
                  } ?>
    ...
    $result2 = $BOR2 / $ob2;
      ...
      $ksa2 = $gmt2 / 2;
         ...
         ?>
                  ...
                  <?php 
       $show_rpt = mysql_query("insert into aggallzoba(estabname,ro,bo,ror,bor,ppr,nr,res,overall,nonres,resident,total) 
        values('Anseba','$t2','$m2','$ford2','$camry2','$ferrari2','$lambo2','$das2','$carbo2','$twit2','$book2','$pen2')"); 
                  } ?>
    ...
    $result3 = $BOR3 / $ob3;
      ...
      $ksa3 = $gmt3 / 2;
         ...
         ?>
                  ...
                  <?php 
$show_rpt = mysql_query("insert into aggallzoba(estabname,ro,bo,ror,bor,ppr,nr,res,overall,nonres,resident,total) 
        values('Northern-Red-Sea','$t3','$m3','$ford3','$camry3','$ferrari3','$lambo3','$das3','$carbo3','$twit3','$book3','$pen3')"); 
                  } ?>
    ...
    $result4 = $BOR4 / $ob4;
      ...
      $ksa4 = $gmt4 / 2;
         ...
         ?>
                  ...
                  <?php 
$show_rpt = mysql_query("insert into aggallzoba(estabname,ro,bo,ror,bor,ppr,nr,res,overall,nonres,resident,total) 
        values('GashBarka','$t4','$m4','$ford4','$camry4','$ferrari4','$lambo4','$das4','$carbo4','$twit4','$book4','$pen4')"); 
                  } ?>
    ...
    $result5 = $BOR5 / $ob5;
      ...
      if(!empty($t5) && !empty($m5) && !empty($candy5) && !empty($dell5) && !empty($camry5) 
         ...
         ?>
                  ...
                  <?php 
$show_rpt = mysql_query("insert into aggallzoba(estabname,ro,bo,ror,bor,ppr,nr,res,overall,nonres,resident,total) 
        values('Southern-Red-Sea','$t5','$m5','$ford5','$camry5','$ferrari5','$lambo5','$das5','$carbo5','$twit5','$book5','$pen5')"); 
                  } ?>
...
?> 
   ...
   <!-- this row will not appear when printing -->
       <div id="samm" class="container"> 
          <form action="aggallzoba.php" method="POST">
...
<?php
  ...
  {
  echo "<script type=\"text/javascript\"> alert( \"First Sumbit Your Entry \");  window.location = \"reportaggallzoba.php\"  </script>";
  }
  ?>
</body>
</html>
